...
@Tag(name = "FoodsAdmin", description = "Gestión de alimentos admin")
@RestController
@RequestMapping("/api/v1/admin/food")
public class FoodControllerAdmin {
    ...
    @Autowired
    public FoodControllerAdmin(FoodService foodService, AuthoritiesService authoritiesService) {
