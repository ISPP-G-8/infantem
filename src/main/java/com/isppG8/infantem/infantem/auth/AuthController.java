...
public class AuthController {
    ...
    @Operation(summary = "Solicitar recuperación de contraseña", description = "Envía un correo con un enlace para restablecer la contraseña si el correo está registrado.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Solicitud procesada (aunque no se revele si el correo existe)", content = @Content(schema = @Schema(implementation = MessageResponse.class))),
    ...
    @Operation(summary = "Restablecer contraseña", description = "Permite restablecer la contraseña de un usuario utilizando un token recibido por correo electrónico.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Contraseña restablecida correctamente", content = @Content(schema = @Schema(implementation = MessageResponse.class))),
