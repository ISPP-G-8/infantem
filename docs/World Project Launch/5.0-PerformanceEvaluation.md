...
| Vargas Muñiz, David            | 10   | 9   | 9,5  | 10  | 9,5  | 96%    | 9,63  | 100%  |
...
- Creacion del disfraz de Spoony
- Creacion de contenido con el disfraz de Spoony
- Redacción e inserción de artículos en la newsletter de la landing page.
- Desarrollo en la landing page (secciones de rrss y newsletter).
- Revisión y actualización de la documentación final del proyecto.
- Organización y análisis del feedback de los usuarios piloto.
- Documento de marketing (actualización feedback recibido y presentación).
...
- Asistencia a clase.
- Actuacion como mascota de proyecto.
- Creacion del disfraz de Spoony
...
- Asistencia a las sesiones de defensa del proyecto.
- Asistencia a clase.
- Actualización de últimos errores de la aplicación.
- Desplegar nuevo contenido de la landing page.
- Actualizar enlace a la versión final de la aplicación en la landing page.
